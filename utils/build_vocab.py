...
def build_vocab(json_file, threshold):
    ...
    for imageid in caption_reader:
        items = caption_reader[imageid]
...
if __name__ == '__main__':
    main(json_file='D:/python/report_pytorch_ok_same_adaptive_attention_convert_loss_copy/data/new_data/try/captions.json',
         threshold=0,
         vocab_path='D:/python/report_pytorch_ok_same_adaptive_attention_convert_loss_copy/data/new_data/try/vocab.pkl')
